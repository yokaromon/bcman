...
export function CardReviewBody({ cardId, failed, confirmLabel, previewRotation, onConfirmed, onRotationChange, onImageRevision, onOrientationCommitted, onBusyChange }: Props) {
